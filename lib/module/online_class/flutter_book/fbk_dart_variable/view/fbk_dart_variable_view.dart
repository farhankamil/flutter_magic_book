...
class FbkDartVariableView extends StatefulWidget {
  ...
  bool? exercise3() {
    ...
    String text = "30024";
    price = double.parse(text.replaceAll(text, "300.24"));
  ...
  bool? exercise8() {
    ...
    */
    ...
    String textBetweenQuotes = text.substring(startIndex, endIndex);
    name = textBetweenQuotes;
    return name == 'Deny';
  }
  ...
  bool? exercise9() {
    ...
    */
    ...
    total = average / numbers.length;
    // print(total.toStringAsFixed(2));
    return total.toStringAsFixed(2) == "57.43";
  }
  ...
  bool exercise19() {
    ...
    String? output = input.split(" ").first;
    // print(output);
    return output == "Hello";
  }
  ...
  bool exercise21() {
    ...
    // print("Apakah $input bilangan genap? $output");
    return output == false;
  }
  ...
  bool exercise29() {
    ...
    // [1]: Kode ini mengambil elemen ke-1 dari array yang dihasilkan dari split(). Dalam hal ini, elemen ke-1 mengacu pada bagian bilangan setelah koma.
    // print(output);
    return output == true;
  }
...
// Tuliskan kode untuk membatasi jumlah karakter pada input menjadi 50 karakter
    String? output = "${input.substring(0, 47)}...";
